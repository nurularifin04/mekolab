...
import { parseData, mekoBlocks, selectedId, jsqrDecode, displayBlocks, displayNewSelection, qrGenerate } from "./level-processor.js"
import { show, hide, textToBytes, createDropdown, versionHeader, updateGrid, SourSwal, Decode } from "./utils.js";
...
ui.image.versionButton.addEventListener('click', () => {
  window.location.href = '/';
});

ui.image.generateButton.addEventListener('click', () => {
  if (!mekoBlocks) {
    SourSwal.fire({
